...
public class BookingController {
    ...
    public ResponseEntity<Object> approve(@RequestHeader(HEADER_USER_ID) Long userId, @PathVariable Long bookingId,
    ...
    @GetMapping
    public ResponseEntity<Object> getAllBookingsByBookerId(@RequestHeader(HEADER_USER_ID) Long userId,
